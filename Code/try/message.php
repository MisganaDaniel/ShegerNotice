...
echo " There is no Record in register table";
}
 $sql=mysql_query("SELECT * FROM feedback where email='$user'");
...
while($r=mysql_fetch_assoc($sql))
{
             echo"<tr><td><hr><h2>Name :  ".$r['name']."</h2><br></td></tr>";
             echo"<tr><td><h3><Feedback : <br> ".$r['feedback']."</h3><br></td></tr>";
}
echo "</table>";
}
else
echo " <tr><td align=center colspan=5>There is no Record in feedback table!</td></tr></table>";

?>
<form method="POST" action="message.php">
<table  cellpadding="10" cellspacing="10">
<tr><td ><img src="pic/lo.png"/></td></tr>
<tr><th>MESSAGE FORM</th></tr>
