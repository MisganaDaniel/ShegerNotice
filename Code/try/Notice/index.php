...
<button id = "submit" type = "submit"><img src ="pic/search.png" alt = "search logo" width="17pt"></button>
    ...
    <nav>
     ...
     <h2>Welcome To Sheger Notice</h2>
<p>
 A place where you can post your advert and <br>
notice to be viewed by millions of people and beyond.<br>
We hope to be the No.1 Advertising campany for Addis Abeba.<br>
We are new and progressive.
</p>
...
<li><a href="Advert_Baverage\baverage_home.php">Beverage</a>
         <ul>
                  ...
                  <li><a href="alcohols.php">Alcohol</a></li>
                   ...
                   <li><a href="medical_center.php">Medical center</a>
                      <ul>
      ...
      <li><a href="clinic.php">Medical Centers</a>
                     <ul>
...
<ul>
        ...
        <li><a href ="sale.php">Sale</a>
         ...
         <li><a href ="bill.php">Bills</a>
													 ...
													 <ul>
														<li><a href="phone.php">Phone Bills</a></li>
														 <li><a href="electric.php">Electric Bills</a></li>
