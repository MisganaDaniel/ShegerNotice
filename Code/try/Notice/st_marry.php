...
<button id = "submit" type = "submit"><img src ="pic/search.png" alt = "search logo" width="17pt"></button>
  ...
  <section>
     ...
     <h2>Unity University Notice</h2>
<div class="place">
<a href="unity_universty.php"><img src="../Notice/baverage_pics/4.jpg"></a>
<STYLE TYPE="text/CSS">
<!--
#SeventhLayer { position:absolute; left:20px; top:100px;
z-index:3; color:blue; font-size:20pt; padding:40px;
border-style:ridge; border-width:20px; border-color:aqua; }

#EighthLayer { position:absolute; left:90px; top:320px;
z-index:2; color:red; font-size:20pt; padding:40px;
border-style:ridge; border-width:20px; border-color:yellow; }

#NinthLayer { position:absolute; left:380px; top:75px;
...
<BODY>
<DIV ID="SeventhLayer"> This is the <BR>
SeventhLayer Test <BR>
with z-index equals 3. <BR>
It rules! </DIV>
<DIV ID="EighthLayer"> This is the <BR>
EighthLayer Test <BR>
with z-index equals 2. </DIV>
<DIV ID="NinthLayer"> This is the <BR>
NinthLayer Test <BR>
with z-index equals 1. </DIV>
...
<li><a href="Advert_Baverage\baverage_home.php">Beverage</a>
      ...
      <li><a href="unity_universty.php">Unity University</a>
                     <ul>
...
<ul>
         <li><a href="#"> Notice </a>
													   ...
													   <ul>
														  <li><a href="../Notice/jobs.php">Jobs</a></li>
														 <li><a href="../Notice/education.php">Educations</a></li>
														 <li><a href="../Notice/events.php">Events</a></li>
														 <li><a href="../Notice/books.php">Books & magazines</a></li>
